...
/// <summary>
/// Service interface for PrivilegeHistory business logic operations
/// Provides high-level operations for managing PrivilegeHistory entities
/// </summary>
public interface IPrivilegeHistoryService
{
    /// <summary>
    ...
    /// <exception cref="PrivilegeHistoryValidationException">Thrown when PrivilegeHistory data is invalid</exception>
    /// <exception cref="PrivilegeHistoryBusinessRuleViolationException">Thrown when business rules are violated</exception>
    /// <exception cref="BaseServiceException">Thrown when service operation fails</exception>
    ...
    /// <returns>True if PrivilegeHistory was deleted successfully</returns>
    /// <exception cref="PrivilegeHistoryNotFoundException">Thrown when PrivilegeHistory with specified id is not found</exception>
    /// <exception cref="BaseServiceException">Thrown when service operation fails</exception>
