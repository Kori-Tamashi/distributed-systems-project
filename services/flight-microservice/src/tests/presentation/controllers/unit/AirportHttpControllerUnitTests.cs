...
using CreateAirportDTO = presentation.dto.http.Airport.CreateAirportDTO;
using UpdateAirportDTO = presentation.dto.http.Airport.UpdateAirportDTO;
...
using AirportInternalServerException = presentation.exceptions.http.AirportInternalServerException;
...
public class AirportHttpControllerUnitTests
{
    ...
    [Fact]
    [Unit]
    public async Task GetAirportById_ValidId_AirportNotFound_ShouldReturnNotFound()
    {
        // Arrange
        var airportId = 999;
    ...
    [Fact]
    [Unit]
    public async Task GetAirportById_ServiceError_ShouldThrowException()
    {
        // Arrange
        var airportId = 1;
        _mockService.Setup(s => s.GetByIdAsync(airportId))
        ...
        // Act & Assert
        await Assert.ThrowsAsync<AirportInternalServerException>(
            () => _controller.GetAirportById(airportId)
        );
    }
    ...
    [Fact]
    [Unit]
    public async Task GetAllAirports_NoFilter_ShouldReturnOkWithList()
    {
        // Arrange
    ...
    [Fact]
    [Unit]
    public async Task GetAllAirports_ServiceError_ShouldThrowException()
    {
        // Arrange
        ...
        // Act & Assert
        await Assert.ThrowsAsync<AirportInternalServerException>(
            () => _controller.GetAllAirports(null, null)
        );
    }
    ...
    [Fact]
    [Unit]
    public async Task GetAllAirports_WithPagination_ShouldApplyPagination()
    {
        // Arrange
        var airports = AirportMother.CreateAirportList(100);
        _mockService.Setup(s => s.GetAllAsync(null)).ReturnsAsync(airports);

        // Act
        var result = await _controller.GetAllAirports(page: 2, pageSize: 10);
    ...
    /// <summary>
    /// EP2: Invalid airport (empty name) - should return 400 Bad Request
    /// </summary>
    [Fact]
    [Unit]
    public async Task CreateAirport_InvalidAirport_EmptyName_ShouldReturnBadRequest()
    {
        // Arrange
    ...
    [Fact]
    [Unit]
    public async Task CreateAirport_ServiceError_ShouldThrowException()
    {
        // Arrange
        var createDto = new CreateAirportDTO
        {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<AirportInternalServerException>(
            () => _controller.CreateAirport(createDto)
        );
    }
    ...
    /// <summary>
    /// EP1: Valid airport, Airport exists - should return 200 OK with updated Airport
    /// </summary>
    [Fact]
    [Unit]
    public async Task UpdateAirport_ValidAirport_AirportExists_ShouldReturnOk()
    {
        // Arrange
        var airportId = 1;
        var updateDto = new UpdateAirportDTO(airportId)
        {
        ...
        updatedAirport.Name = updateDto.Name;
        updatedAirport.City = updateDto.City;
        
        _mockService.Setup(s => s.GetByIdAsync(airportId)).ReturnsAsync(existingAirport);
        _mockService.Setup(s => s.UpdateAsync(It.IsAny<core.domain.Airport>())).ReturnsAsync(updatedAirport);
        ...
        _mockService.Verify(s => s.UpdateAsync(It.IsAny<core.domain.Airport>()), Times.Once);
    }
    ...
    /// <summary>
    /// EP3: Invalid airport (empty name) - should return 400 Bad Request
    /// </summary>
    [Fact]
    [Unit]
    public async Task UpdateAirport_InvalidAirport_EmptyName_ShouldReturnBadRequest()
    {
        // Arrange
        var airportId = 1;
        var updateDto = new UpdateAirportDTO(airportId)
    ...
    public async Task UpdateAirport_IdMismatch_ShouldReturnBadRequest()
    {
        // Arrange
        var airportId = 1;
        var updateDto = new UpdateAirportDTO(999) // Different from route ID
        {
            Name = "Updated Airport Name"
        };
    ...
    [Fact]
    [Unit]
    public async Task UpdateAirport_ServiceError_ShouldThrowException()
    {
        // Arrange
        var airportId = 1;
        var updateDto = new UpdateAirportDTO(airportId)
        ...
        _mockService.Setup(s => s.GetByIdAsync(airportId)).ReturnsAsync(AirportMother.CreateValidAirport());
        _mockService.Setup(s => s.UpdateAsync(It.IsAny<core.domain.Airport>()))
            .ThrowsAsync(new Exception("Database error"));

        // Act & Assert
        await Assert.ThrowsAsync<AirportInternalServerException>(
            () => _controller.UpdateAirport(airportId, updateDto)
        );
    }
    ...
    /// <summary>
    /// EP1: Valid ID, Airport exists - should return 200 OK
    /// </summary>
    [Fact]
    [Unit]
    public async Task DeleteAirport_ValidId_AirportExists_ShouldReturnOk()
    {
        // Arrange
        var airportId = 1;
        _mockService.Setup(s => s.DeleteAsync(airportId)).ReturnsAsync(true);
    ...
    [Fact]
    [Unit]
    public async Task DeleteAirport_ValidId_AirportNotFound_ShouldReturnNotFound()
    {
        // Arrange
        var airportId = 999;
    ...
    [Fact]
    [Unit]
    public async Task DeleteAirport_ServiceError_ShouldThrowException()
    {
        // Arrange
        var airportId = 1;
        _mockService.Setup(s => s.DeleteAsync(airportId))
